...
In this folder, you can find a selection of courses (and accompanying jupyter notebooks, rmd files, and/or pdfs of lectures) that represent many of the fundamental skills of  higher education. When creating material for courses, I have especially focused on: cultivating and improving critical thinking ("what are the important features in this dataset?"), quantifying uncertainty ("How much can we trust these data under specific models"), evaluating data quality ("Do these data represent objective 'truth' about a relationship/pattern?","How can we assess this knowledge appropriately?", and "What are the assumptions embedded in our data/experiment"?), and writing effectively and clearly about ambiguity. 
...
9. **"Precision Medicine: Customizing Care through Genetics"**  https://rochesteronline.precollegeprograms.org/medicine This was a collaboration between the University of Rochester and Kaplan and the material was co-developed by both me and Alexis Stein, Ph.D. and the target audience was high school students. I have not included a syllabus, but I have pasted the link in case you are interested. I included two live lectures that I gave to supplement the course material over summer 2022. The topic was on the underrepresentation of diverse genomes in large genomic databases and why, due to the non-portability of Polygenic Risk Scores, this is a *big problem* that limits the promise of precision medicine.   
